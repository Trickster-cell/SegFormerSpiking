...
class SegFormerModel(pl.LightningModule):
    def __init__(self):
        ...
        self.criterion = smp.losses.SoftCrossEntropyLoss(reduction='mean', smooth_factor=0.1, ignore_index=-100, dim=1)
    ...
    def configure_optimizers(self):
        ...
        scheduler = ReduceLROnPlateau(optimizer, mode='min', factor=0.25, patience=3, verbose=True, threshold=0.002)
...
tb_logger = TensorBoardLogger("logs/", name = "SegFormer_v2_epoch501_SoftCrossEntropy")
...
weights_path = "segformer_100epochs_model_weightsSoftCrossEntropy.pth"
