...
class SegFormerModel(pl.LightningModule):
    ...
    def configure_optimizers(self):
        optimizer = torch.optim.Adam(self.parameters(), lr=0.00006)
...
datamodule = SegFormerDataModule(batch_size=8)
...
tb_logger = TensorBoardLogger("logs/", name = "SegFormer_v2_epoch501_LovaszLoss")
...
weights_path = "segformer_100epochs_model_weightsLovaszLoss.pth"
